...
function SweetView() {
    ...
    const handleSearch = () => {
        // You can use filters to make an API call or filter locally
        console.log(filters);
    };
        ...
        <div className="relative w-full h-full pt-5 flex flex-col gap-5">
            ...
            {modal && <div onClick={() => setModal(false)} className="fixed inset-0 bg-black/20 bg-opacity-80 backdrop-blur-[1px] flex justify-center items-center z-50">
                <div
                    ...
                    />
                    <button onClick={() => alert("hello")} className='w-full cursor-pointer border border-gray-300 px-3 py-2 rounded-md bg-green-400 hover:bg-green-500 duration-200' >Submit</button>
